...
PRINT ''
PRINT '-------------------------------------------'
PRINT 'Starting execution of UninstallSqlState.SQL'
PRINT '-------------------------------------------'
GO
...
IF UPPER(@sstype) <> 'SSTYPE_PERSISTED' AND DB_ID(N'tempdb') IS NOT NULL BEGIN
    IF OBJECT_ID(N'[tempdb].dbo.ASPStateTempSessions','U') IS NOT NULL BEGIN
        DROP TABLE [tempdb].dbo.ASPStateTempSessions
    END

    IF OBJECT_ID(N'[tempdb].dbo.ASPStateTempApplications','U') IS NOT NULL BEGIN
        DROP TABLE [tempdb].dbo.ASPStateTempApplications
    END
...
PRINT ''
PRINT '--------------------------------------------'
PRINT 'Completed execution of UninstallSqlState.SQL'
PRINT '--------------------------------------------'
